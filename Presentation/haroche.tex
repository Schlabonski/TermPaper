...
\begin{frame}[t]{Serge Haroche: Scientific Carreer}
  ...
  \visible<4>{\picpos{3.7cm}{0.5cm}{2.5cm}{v_type_quantum_beats.pdf}}
  \visible<4>{\begin{textblock*}{3cm}(0.5cm,2cm)V-type\end{textblock*}}
  \visible<4>{\picpos{3.7cm}{5.5cm}{2.5cm}{lambda_type_quantum_beats.pdf}}
  \visible<4>{\begin{textblock*}{3cm}(5.5cm,2cm)$\Lambda$-type\end{textblock*}}
  \visible<5->{\picpos{3.7cm}{0.5cm}{1.5cm}{SH_quantum_beats_plot.pdf}}
...
\begin{frame}[t]{Serge Haroche: CQED}
  ...
  \visible<4>{\picpos{4cm}{6.3cm}{3cm}{SH_supression_spont_em_scheme.pdf}}
  \visible<5>{\picpos{4cm}{6cm}{2.5cm}{SH_supression_spont_em_results.pdf}}
