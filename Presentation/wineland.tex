...
\begin{frame}[t]{David Wineland: Research}
  ...
  \visible<3>{\picpos{9cm}{.7cm}{4.1cm}{dehmelt_mono_ion_title.pdf}}
...
\begin{frame}[t]{David Wineland: Ion Quantum Jumps}
  \portraitpic{wineland.jpg}
  \visible<3>{
    \picpos{5.2cm}{6.8cm}{3.7cm}{DW_quantum_jumps_results.pdf}
    \textpos{5cm}{7cm}{5.7cm}{\small $\rightarrow$ discrete occupation
    of ground or excited state}
  }
  \visible<1>{
    \picpos{8cm}{0.5cm}{1.9cm}{DW_quantum_jumps_title.pdf}
  }

  \visible<2->{\picpos{7.5cm}{0cm}{1.9cm}{dw_quantum_jumps_scheme.pdf}}
  \visible<2>{\textpos{5cm}{7.2cm}{4.5cm}{\small fluorescence only when ion occupies
    ground state}}
...
\begin{frame}[t]{David Wineland: Quantum Logic Gate}
  ...
  \visible<3-5>{\textpos{6cm}{5.4cm}{3.8cm}{\begin{itemize}\item 4 possible pure
      states \item superposition states can be engineered by Rabi
...
\begin{frame}[t]{David Wineland: Quantum Logic Gate}
  \portraitpic{wineland.jpg}
  \visible<2->{\picpos{4cm}{0.8cm}{2.5cm}{controled_not.pdf}}
